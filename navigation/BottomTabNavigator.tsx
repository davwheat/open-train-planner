    ...
    <Host>
      ...
      >
        ...
        <BottomTab.Screen
          ...
          options={{
            tabBarIcon: ({ color }) => (
              <TabBarIcon name="ios-stopwatch-outline" color={color} />
            ),
          }}
        />
        <BottomTab.Screen
          ...
          options={{
            tabBarIcon: ({ color }) => (
              <TabBarIcon name="ios-map-outline" color={color} />
            ),
          }}
        />
      </BottomTab.Navigator>
...
function LiveTrainsNavigator() {
  return (
    <LiveTrainsStack.Navigator>
      <LiveTrainsStack.Screen
        name="Live Trains"
        component={LiveTrainsScreen}
        options={{ headerTitle: "Live Trains" }}
      />
    </LiveTrainsStack.Navigator>
  );
}
...
function TrainPlannerNavigator() {
  return (
    <TrainPlannerStack.Navigator>
      <TrainPlannerStack.Screen
        name="Train Planner"
        component={TrainPlannerScreen}
        options={{ headerTitle: "Train Planner" }}
      />
    </TrainPlannerStack.Navigator>
  );
}
